...
class Permission(models.Model):
    ...
    pid = models.ForeignKey(verbose_name='关联的权限', to='Permission', null=True, blank=True, related_name='parents', help_text='对于非菜单权限需要选择一个可以成为菜单的权限，用户默认展开和选中菜单',on_delete=models.CASCADE)
    def __str__(self):
        return self.title
